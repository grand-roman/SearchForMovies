...
class Search extends AbstractComponent {
  ...
  getTemplate() {
    return `<form class="header__search search">
          ...
          <svg fill="#ff2400" class="search__film-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 20 19">
  ...
  startSearch() {}
  researchValue() {
    return this._element.querySelector(`.search__field`).value;
  }
}
